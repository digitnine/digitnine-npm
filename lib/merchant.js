...
module.exports = {
    ...
    getListOfBanksByServiceProviderId: async function (params) {
        try {
            if ((params.serviceProviderId && params.ctryCode && params.ccyCode) !== null && (params.serviceProviderId && params.ctryCode && params.ccyCode) !== undefined) {
                const headers = {
                    headers: {
                        Authorization: "Bearer " + this.authToken,
                    },
    ...
    getListOfServiceProviders: async function (params) {
        try {
            if ((params.ctryCode && params.ccyCode) !== null && (params.ctryCode && params.ccyCode) !== undefined) {
                const headers = {
                    headers: {
                        Authorization: "Bearer " + this.authToken,
                    },
