...
module.exports = {
    ...
    updateMerchantwallet: async function (id) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-service-wallets/${id}`;
    ...
    getMerchantBeneficiaryById: async function (id) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-service-beneficiaries/${id}`;
            const res = await axios.get(url, headers);
    ...
    getListOfMerchantBeneficiaries: async function (params) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-service-beneficiaries`;
            url += `?page=${params.page}&size=${params.size}`;
            if (params.type !== null && params.type !== undefined) {
                url += `&type=${params.type}`;
            }
    ...
    createBankAcctForServiceProvider: async function (params) {
        try {
            let body = params;
            eps.isProduction = this.isProduction;
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/wallets`;
            const headers = {
                headers: {
                    Authorization: "Bearer " + this.authToken,
                },
    ...
    getListOfMerchanWallets: async function (params) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/merchant-service/wallets`;
            url += `?page=${params.page}&size=${params.size}`;
    ...
    getMerchantWalletById: async function (id) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/merchant-service/wallets/${id}`;
            const res = await axios.get(url, headers);
    ...
    getListOfDocsCurrentMerchantProfile: async function (merchantProfileID) {
        try {
          ...
          let url =
            eps.getMerchantServiceUrl() +
            `/v1/service-provider/merchant-profiles/${merchantProfileID}/documents`;
          console.log("-------------");
          console.log(url);
    ...
    createMechantProfileDoc: async function (params) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-profiles/${merchantProfileID}/documents`;
            const res = await axios.post(url, body, headers);
    ...
    getListOFServiceProviderExecutiveDocs: async function () {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/executive-documents`;
            const res = await axios.get(url, headers);
    ...
    getListOFServiceProviderRiskScoringAssesments: async function () {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/risk-assessments`;
            const res = await axios.get(url, headers);
    ...
    deleteMerchantProfileById: async function (params) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-profiles/${params.merchantProfileID}/comments/${params.commentID}`;
    ...
    getListOfCommentsCurrentMerchantProfile: async function (merchantProfileID) {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-profiles/${merchantProfileID}/comments`;
            const res = await axios.get(url, headers);
    ...
    getListOfServiceProviderKYCs: async function () {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/kycs`;
            const res = await axios.get(url, headers);
    ...
    getListOfFeesOfServiceProvider: async function () {
        try {
            ...
            let url = eps.getMerchantServiceUrl() + `/v1/service-provider/fees`;
            const res = await axios.get(url, headers);
    ...
    getMerchantProfileById: async function (id) {
        ...
        try {
            ...
            if (merchantProfileId !== null || merchantProfileId !== undefined) {
                ...
                let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-profiles/${merchantProfileId}`
                console.log(url)
                const headers = {
                    'headers': {
                        'Authorization': 'Bearer ' + this.authToken,
    ...
    updateMerchantProfileById: async function (id,body) {
        ...
        try {
                ...
                let url = eps.getMerchantServiceUrl() + `/v1/service-provider/merchant-profiles/${id}`
                console.log(url)
                const headers = {
                    'headers': {
                        'Authorization': 'Bearer ' + this.authToken,
